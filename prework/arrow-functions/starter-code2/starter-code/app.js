...
//  The function console.logging joe
// 2. What is "this" when joe.scopeArrow() is invoked?
// The window object of student
// 3. Explain why "this" is different when an arrow function is used.
// Defining a method on the student constructor, inside of the method this refers to the instance of the constructor, compared to scope ARROW is a method, but it loses its reference of THIS student ????
// SAVE THIS AS A QUESTION FOR CLASS ^^^^^^^
