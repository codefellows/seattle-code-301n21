...
let tom = new Student('tom', 'Schmoe', 100);
...
// 'this' is bound to instance of Student that was created (joe)
// 2. What is "this" when joe.scopeArrow() is invoked?
// 'this' is bound to the window object of Student
// 3. Explain why "this" is different when an arrow function is used.
//  With regular functions, the 'this' keyword is bound to different values based on the context in which the function is called. Arrow functions use the value of 'this' in their lexical scope.
